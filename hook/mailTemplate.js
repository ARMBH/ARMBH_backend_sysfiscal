      ...
      <td class="container"
        ...
        <div class="content"
          ...
          <span class="preheader"
            style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">${historico_texto}</span>
          <table class="main"
                ...
                <table border="0" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                      <td align="center" style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                          <p
                            style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><img width="350" src="http://www.agenciarmbh.mg.gov.br/wp-content/uploads/2019/08/2-Marca-ARMBH-Colorida-RGB.png" alt="Sistema de Fiscalização ARMBH" ></p></td>
                  </tr>
                  <tr>
          ...
          <div class="footer" style="clear: both; Margin-top: 10px; text-align: center; width: 100%;">
            <table border="0" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td class="content-block"
                  style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                  <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Este é um e-mail automático. Favor não responder.
                </td>
              </tr>
            </table>
          </div>
